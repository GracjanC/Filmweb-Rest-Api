...
public class QueryStringParser {
    ...
    public QueryStringParser(String queryString, String charsetName)
            throws NullPointerException, IllegalCharsetNameException,
            IllegalArgumentException, UnsupportedCharsetException {
